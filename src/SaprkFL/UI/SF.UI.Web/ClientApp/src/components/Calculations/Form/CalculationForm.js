    ...
    render() {
        ...
        return (
            <form onSubmit={this.props.handleSubmit(this.onSubmit)}>
                ...
                <CalculationFormNumberField label="Przychody" name="previusMonthsIncomes" min="0" helpText="Przychód z poprzednich miesięcy netto" />
                <CalculationFormCheckField label="Ubezpieczenie zdrowotne?" name="isMedicalInsurance" />
